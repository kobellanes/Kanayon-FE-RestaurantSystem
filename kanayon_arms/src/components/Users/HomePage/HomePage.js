                ...
                <div className="container-fluid px-5">
                    ...
                    <div className="px-4">
                        ...
                        <div className="col-12 text-start fs-4 text-light fw-light">
                            <p className="dese-parag lh-lg">At Kanayon Inasal, we believe that food should not only be delicious but also a source of joy and happiness. We take pride in creating meals that not only satisfy your hunger but also put a smile on your face. Our chefs are passionate about what they do and use only the freshest and finest ingredients to create dishes that are bursting with flavor.</p>
                            <h4 className="dese-parag1 lh-lg fst-italic text-center">"Come and experience the joy of delicious meal that is made with love and care. Let our food be the reason you smile today. We look forward to serving you!"</h4>
                        </div>
                    </div>
