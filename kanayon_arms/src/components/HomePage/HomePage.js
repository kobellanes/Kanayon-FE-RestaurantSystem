            ...
            <section className="py-0">
                ...
                <div className="container">
                    ...
                    <div className="row h-100">
                        ...
                        <div className="col-12">
                            ...
                            <div className="carousel slide" id="carouselBestDeals" data-bs-touch="false" data-bs-interval="false">
                                ...
                                <div className="carousel-inner">
                                        ...
                                        <div className="row h-100 align-items-center g-2">
                                            ...
                                            <div className="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                                ...
                                                <div className="card card-span h-100 text-white">
                                                    <img className="img-fluid h-100" src={customers2} alt="..." />
                                                    ...
                                                    <div className="card-body ps-0 bg-200">
                                                        ...
                                                        <div className="fw-bold"><span className="text-600 me-2 text-decoration-line-through">$200</span><span
                                                            className="text-primary">$175</span></div>
                                                    </div><a className="stretched-link" href="#"></a>
                                                </div>
                                            </div>
                                            <div className="col-sm-6 col-md-3 mb-3 mb-md-0 h-100">
                                                <div className="card card-span h-100 text-white"><img className="img-fluid h-100"
                                                    src={customers2} alt="..." />
                                                    <div className="card-img-overlay ps-0"> </div>
                                                    <div className="card-body ps-0 bg-200">
                                    ...
                                    <div className="row">
                                        <button className="carousel-control-prev" type="button" data-bs-target="#carouselBestDeals"
                                        ...
                                        <button className="carousel-control-next" type="button" data-bs-target="#carouselBestDeals"
                        ...
                        <div className="col-12 d-flex justify-content-center mt-5"> <a className="btn btn-lg btn-dark" href="#!">View All </a>
                        </div>
                    </div>
                </div>
